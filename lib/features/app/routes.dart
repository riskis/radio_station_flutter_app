      ...
      GoRoute(
        ...
        routes: <RouteBase>[
          GoRoute(
              ...
              builder: (context, state) {
                final PlayRadioStationBloc playRadioStationBloc =
                    serviceLocator<PlayRadioStationBloc>();

                return BlocProvider.value(
                  value: playRadioStationBloc
                    ..add(PlayRadioStationInitialEvent(
                        state.extra as RadioStationExtraEntity)),
